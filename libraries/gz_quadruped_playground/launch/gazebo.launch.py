...
def launch_setup(context, *args, **kwargs):
    ...
    # Controllers
    # The simplified project keeps OCS2/RL controllers and uses the OCS2 playground path.
...
def generate_launch_description():
    ...
    controller = DeclareLaunchArgument(
        'controller',
        default_value='ocs2',
        description='The ROS2-Control controller set (OCS2 only in simplified project)'
    )
