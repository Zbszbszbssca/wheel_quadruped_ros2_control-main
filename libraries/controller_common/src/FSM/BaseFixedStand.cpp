...
void BaseFixedStand::run(const rclcpp::Time&/*time*/, const rclcpp::Duration&/*period*/)
{
    ...
    std::ignore = ctrl_interfaces_.joint_velocity_command_interface_[12].get().set_value(0.0);  // FR_foot
    std::ignore = ctrl_interfaces_.joint_velocity_command_interface_[13].get().set_value(0.0);  // FL_foot
    std::ignore = ctrl_interfaces_.joint_velocity_command_interface_[14].get().set_value(0.0);  // RR_foot
    std::ignore = ctrl_interfaces_.joint_velocity_command_interface_[15].get().set_value(0.0);  // RL_foot
}
