...
#include <ocs2_mpc/SystemObservation.h> // 新增头文件
...
namespace ocs2::legged_robot
{
    ...
    public:
        ...
        virtual vector_t update(const SystemObservation& observation, const rclcpp::Time& time, const rclcpp::Duration& period) = 0;
